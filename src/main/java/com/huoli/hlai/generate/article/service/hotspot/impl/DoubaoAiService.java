...
@Slf4j
@Service
public class DoubaoAiService implements AiModelService {
    ...
    public boolean supports(String modelType) {
        return "DOUBAO".equalsIgnoreCase(modelType);
    }
    ...
    public String analyze(List<String> keywords, List<RawHotspotItem> hotspots) {
        log.info("[Doubao] 开始分析热点数据，关键词：{}，热点数量：{}", keywords, hotspots.size());
    ...
    /**
     * 构造热点分析 Prompt（与 DeepSeek 类似，可根据 Doubao 特点调整）
     */
